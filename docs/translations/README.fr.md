...
Par défaut, Escalated rend les pages via [Inertia.js](https://github.com/inertiajs/inertia-phoenix) lorsque `inertia` est installé. Si Inertia n'est pas disponible, les contrôleurs renvoient des réponses JSON.
